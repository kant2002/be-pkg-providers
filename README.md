...
This repository contains the package with common providers.
...
In order to install and use the linked dependencies for `pkg-providers` the following command can be used:
